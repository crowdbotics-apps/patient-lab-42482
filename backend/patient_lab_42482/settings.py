"""
Django settings for patient_lab_42482 project.
...
ROOT_URLCONF = 'patient_lab_42482.urls'
...
WSGI_APPLICATION = 'patient_lab_42482.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_lab_42482 API",
    "DESCRIPTION": "API documentation for patient_lab_42482 App",
    "VERSION": "v1",
}
